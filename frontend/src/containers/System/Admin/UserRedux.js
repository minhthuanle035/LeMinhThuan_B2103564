...
class UserRedux extends Component {
    ...
    //         console.log("Creating new user:", this.state);
    ...
    //         console.log("Editing user:", this.state.userEditId);
            ...
            <div className='user-redux-container'>
                ...
                <div className="user-redux-body" >
                    <div className='container'>
                        <div className='row'>
                            <div className='col-12 my-3'><FormattedMessage id="manage-user.add" />
                            </div>
                                ...
                                >
                                    {genders && genders.length > 0 &&
                                        genders.map((item, index) => {
                                            return (
                                                <option
                                                    key={index} value={item.keyMap} >{language === LANGUAGE.VI ? item.valueVi : item.valueEn}
                                                </option>
                                            )
                                        })
